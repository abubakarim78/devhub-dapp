...
entry fun accept_connection_request(store: &mut ConnectionStore, req: ConnectionRequest, ctx: &TxContext) {
...
entry fun decline_connection_request(req: ConnectionRequest, _ctx: &TxContext) {
