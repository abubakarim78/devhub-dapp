...
const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ className, onNavigate }) => {
  ...
  return (
    <motion.aside 
      ...
      className={className}
    >
      <div className="lg:sticky lg:top-0 lg:w-[320px] xl:w-[280px] max-lg:w-full bg-secondary/50 backdrop-blur-xl rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-border shadow-2xl shadow-primary/5 lg:overflow-visible lg:z-30 max-lg:max-h-[calc(100vh-8rem)] max-lg:overflow-y-auto max-lg:overflow-x-hidden scrollbar-hide">
